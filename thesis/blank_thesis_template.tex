...
\subsection{Graphs and graph representation learning}\label{sec:traditional_grl}
...
\subsubsection{Transductive nature of traditional GRL}
...
\subsubsection{Implications for large-graph training}
...
\subsection{Graph neural networks for large graphs}
...
\subsubsection{Training under memory constraints}
...
\subsection{PyTorch Geometric}\label{sec:pyg}
...
\subsection{Neo4j and graph databases}
...
\subsubsection{Alternatives to Neo4j}
...
\subsubsection{Querying Neo4j with Cypher and procedures}
...
\subsubsection{Data retrieval from Neo4j}
...
\subsubsection{Cypher query execution pipeline}
...
\subsection{Distributed GNN systems}
...
\subsection{Database-backed GNN pipelines}
...
\subsection{Baseline graph-database-backed GNN system}
...
\subsection{Equivalence constraint}
...
\subsection{Graph neural network model}\label{sec:model}
...
\subsection{Sampling algorithms}\label{sec:sampling_algs}
...
\subsubsection{GraphSAINT random-walk sampling}
...
\section{Overall architecture}\label{sec:sys_arch}
...
\subsection{PyTorch Geometric integration}\label{sec:pyg_impl}
...
\section{RQ1 results}
\subsection{RQ1: Bottlenecks}
\subsubsection{Training phase vs. sampling phase}
\subsubsection{Sampling subphases}
\subsubsection{Feature vector datatype}
\subsubsection{Effect of caching}
\subsubsection{Effect of multisampler parallelism}
\subsubsection{Summary of RQ1}

\section{RQ2 results}
\subsection{RQ2: Sampling strategies}
\subsubsection{Neighbor sampling in Neo4j}
\subsubsection{GraphSAINT in Neo4j}
\subsubsection{Summary of RQ2}

\section{RQ3 results}
\subsection{RQ3: Inference with graph stored in Neo4j}
\subsubsection{Inference setting definitions}
\subsubsection{Batch inference performance}
\subsubsection{Inference on newly inserted nodes}
\subsubsection{Summary of RQ3}

\section{RQ4 results}
\subsection{RQ4: Effect of graph size}
\subsubsection{Small graphs}
\subsubsection{Medium graphs}
\subsubsection{Large graphs}
\subsubsection{Summary of RQ4}
...
\subsection{Optimal system implementation}
