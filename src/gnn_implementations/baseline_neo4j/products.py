...
def main(config: dict):
    ...
    num_neighbors = [10, 5]
    sampler = Neo4jSampler(graph_store, num_neighbors=num_neighbors, profile=profile, node_label="Product")

    model_args = {"in_dim": 100, "hidden_dim1": 32, "hidden_dim2": 32, "nbr_classes": 47, "init_weights": config.get("init_weights")}
